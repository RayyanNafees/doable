...
description: use when asked to create an animation or where u see an animation will see fit - like in multi step form step transitions or table CRUD, or when client component is hydrated on server, due to using motion components, so resolve with this
---
