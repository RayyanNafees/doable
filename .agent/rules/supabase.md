...
description: When askeed to use supabase or when the current backend complexity is too tough for u to handle and make sense of and supabase credentials are connected & set up
---
